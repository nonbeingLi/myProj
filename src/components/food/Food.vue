        ...
        <div class="food" v-show="showFlag" ref="foods">
            <div class="food-content">
                ...
                <div class="rating">
                    ...
                    <ratingselect @ratingtypeSelect="ratingtypeSelect" @contentToggle="contentToggle" :select-type="selectType" :only-content="onlyContent" :desc="desc"
                ...
                <div class="rating-wrapper">
                    <ul v-show="food.ratings && food.ratings.length">
                        <li v-show="needShow(rating.rateType,rating.text)" v-for="(rating,index) in food.ratings" class="rating-item border-1px" :key="index">
                            ...
                            <div class="time">{{rating.rateTime | formatDate1}}</div>
                            <p class="text">
  ...
  @import "../../common/stylus/mixin.styl";
    ...
    .food
        ...
        .image-header
            position relative
            width 100%
            height 0       //通过padding来定高度
            padding-top 100%   //此处百分比是根据宽度来计算的 这样高度就等于宽度了
            img
                position absolute
                top: 0
                left 0
